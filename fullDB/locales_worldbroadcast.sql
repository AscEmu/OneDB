...
-- Exportiere Struktur von Tabelle ascemu_world.locales_worldbroadcast
CREATE TABLE IF NOT EXISTS `locales_worldbroadcast` (
  `entry` int NOT NULL,
...
-- Exportiere Daten aus Tabelle ascemu_world.locales_worldbroadcast: 0 rows

...
-- Exportiere Struktur von Tabelle ascemu_world.gossip_menu_option
CREATE TABLE IF NOT EXISTS `gossip_menu_option` (
  ...
  PRIMARY KEY (`entry`)
) ENGINE=InnoDB AUTO_INCREMENT=624 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Gossip Menu';

-- Exportiere Daten aus Tabelle ascemu_world.gossip_menu_option: ~368 rows (ungefähr)
INSERT INTO `gossip_menu_option` (`entry`, `option_text`) VALUES
	...
	(607, 'I\'m not the raid leader...'),
	(608, 'My companions are all accounted for'),
	(609, 'I\'ll wait for the raid leader'),
	(610, 'My companions are all accounted for, Saurfang. Let\'s go!'),
	(611, 'Yeah, I\'m sure that safety is your top priority. Give me a jetpack.'),
	(612, 'You already have my jetpack!'),
	(613, 'Let it begin...'),
	(614, 'We are ready to go, High Overlord. The Lich King must fall!'),
	(615, 'We\'re ready. This time things will be different.'),
	(616, 'Bring forth the first challenge!'),
	(617, 'I am ready for the next challenge.'),
	(618, 'Now.'),
	(619, 'Give the signal! We\'re ready to go!'),
	(620, 'We\'re ready for anything!'),
	(621, 'Val\'kyr? We\'re ready for them.'),
	(622, 'Just bring them out again, then watch.'),
	(623, 'That is strange...');

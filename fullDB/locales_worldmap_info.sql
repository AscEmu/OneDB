...
-- Exportiere Struktur von Tabelle ascemu_world.locales_worldmap_info
CREATE TABLE IF NOT EXISTS `locales_worldmap_info` (
  `entry` int NOT NULL,
...
-- Exportiere Daten aus Tabelle ascemu_world.locales_worldmap_info: 0 rows
/*!40000 ALTER TABLE `locales_worldmap_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `locales_worldmap_info` ENABLE KEYS */;

...
-- Exportiere Struktur von Tabelle ascemu_world.locales_gossip_menu_option
...
-- Exportiere Daten aus Tabelle ascemu_world.locales_gossip_menu_option: ~0 rows (ungefähr)

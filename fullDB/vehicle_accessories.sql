...
-- Exportiere Struktur von Tabelle ascemu_world.vehicle_accessories
...
-- Exportiere Daten aus Tabelle ascemu_world.vehicle_accessories: 198 rows
/*!40000 ALTER TABLE `vehicle_accessories` DISABLE KEYS */;
INSERT INTO `vehicle_accessories` (`entry`, `accessory_entry`, `seat_id`, `minion`, `description`, `summontype`, `summontimer`) VALUES
	...
	(30165, 30166, 0, 1, 'Stormcrest Eagle - Frostborn Stormrider', 8, 30000),
	(28710, 28646, 0, 1, 'Vics Flying Machine', 6, 30000),
	(33109, 33620, 2, 1, 'Salvaged Demolisher - Earthen Stoneshaper', 6, 30000);
